...
func main() {
	...
	r.POST("/api/admin/blog/posts/:id/evaluate", handlers.EvaluateBlogPost)         // 블로그 품질 평가 수동 저장 (관리자)
	r.POST("/api/admin/blog/posts/:id/auto-evaluate", handlers.AutoEvaluateBlogPost) // Gemini API 자동 품질 평가 (관리자)
